...
class KlientiAdmin(admin.ModelAdmin):
    list_display = ['surname', 'name', 'client_blocked', 'card_blocked', 'birthday', 'phone', 'e_mail', 'status', 'sex', 'reg_date', 'notes']
    list_filter = ['client_blocked', 'card_blocked', 'status', 'sex', 'reg_date']
